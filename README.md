...
| 지표 | 의미 |
|------|------|
| 국면(Phase) | 🔴고점권 / 📉하락 중 / 🟢바닥권 / 📈상승 중 / ⏸보합 |
| 현재 낙폭 | `현재 / 역대최고 × 100 − 100` (지금 얼마나 싸졌나) |
| 역대 최대 낙폭 | 과거 하락장 최대 낙폭 (더 빠질 여지 가늠) |
| 모멘텀 | 최근 3·6·12개월 변동률 (0 근처=바닥 신호, 마이너스=하락) |

- **국면 판정**: 역대최고 대비 −2% 이내면 `고점권`, 최근 3개월 −0.3% 이하면
  `하락 중`, −3% 이상 빠지고 하락이 멈추면 `바닥권`, 3개월 +0.3% 이상이면 `상승 중`.
- **매수 후보 필터**: "전고점 대비 X% 이상 하락 + 하락이 멈춘(3개월 ≥ −0.3%)" 구를
  자동 추림. '떨어지는 칼날'을 피하고 바닥권 진입 구만 보는 용도.
